...
//		 testCreateAndInitializeStrategyTable();
	 ...
	 * 1. check the result for 0 sticks
	 * 2. check the result for negative sticks
	 * 3. check the result for sticks that lower than max action
	 * 4. check the result for sticks in normal condition
	 * 5. call 1000 times and set a seed random to check the probability of result
	 */
	 ...
	 * 2. check the result for situation like out of bounce or null
	 * 3. check the result under the array and see if it is between the range
	 * 4. check the result over 1000 times and get a distribution for the sticks action probability
	 */
	 ...
	 * 1. TODO describe the tests in your own words. 
	 * 2. check the result when the array is null
	 * 3. check the result when all the indexes are zeros
	 * 4. check if the array contains negative index
	 */
	 ...
	 * 1. To see if the expected values are returned under the given array
	 * 2. check if it is entered or not, end with "\n"
	 * 3. 
	 */
	 ...
	 * 1. This method test whether the the actionTanking for action will decrease 1 
	 * 
	 */
	 ...
	 * 1. This method test whether the the actionTanking for action will increase 1  
	 * 
	 */
	 ...
	 * 1. This method tests whether the rows are correct.
	 * 2. This method tests whether the columns are correct.
	 * 3. This method tests whether all of the strategyTable are initialized by 1.
	 */
	 ...
	 * 1. This method tests whether the strategyTable are transfered to string
	 * 2. This method tests whether the format of the string is correct.
	 */
	 ...
	 * 1. This method test whether the strategyTable has been updated successfully
	 * 
	 */
	 ...
	 * 1. This method tests whether the players return right. 
	 * 2. 
	 */
	 ...
	 * 1. first check the invalid number first, expecting a null return
	 * 2. check if the strategy table length is the same as the startsticks
	 * 3. check the length of the "width" for the 2d array
	 * 
	 */
